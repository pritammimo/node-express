...
exports.login = catchAsync(async (req, res, next) => {
  ...
  //2)check if user exists && password is exists
...
exports.protect = catchAsync(async (req, res, next) => {
  ...
  //4) check if user cahnge password after the token was issued
  if (freshUser.changedPasswordAfter(decoded.iat)) {
    return next(
      new AppError('User recently cvhanged Password,please log in again', 401)
    );
  }
